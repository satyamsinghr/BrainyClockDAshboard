...
export class StylePaginatorDirective {
  ...
  private buildPageNumbers() {
    ...
    const txt=this.vr.element.nativeElement.querySelector(
        ...
        for (let i = 0; i < nodeArray.length; i++) {
          if (nodeArray[i].nodeName === "BUTTON") {
            if (nodeArray[i].innerHTML.length > 100 && nodeArray[i].disabled) {
              ...
              this.ren.setStyle(nodeArray[i], "color", "#7E57C2");
              ...
              this.ren.setStyle(nodeArray[i], "background-color", "#783FBC");
  ...
  private createButton(i: any, pageIndex: number): any {
    ...
    this.ren.setStyle(linkBtn, "color", "#999898");
    this.ren.setStyle(linkBtn, "border", "1px solid #B9B9BA");
